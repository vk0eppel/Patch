...
void main() {
  test(
    'no file under lib/screens or lib/widgets imports the generated FFI bindings',
    () {
      ...
      expect(
        ...
        isEmpty,
        reason:
            'UI code must issue engine commands through BridgeClient '
